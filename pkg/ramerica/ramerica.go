...
func request() ([]Record, error) {
	...
	// log.Printf("length of records %d", len(sp.Backend.Search.SearchResults.Records))
	return records, nil
}

// return smaller part of the json
// because of https://github.com/99designs/gqlgen/issues/810#issuecomment-518965300
func parseJQ(input string) ([]byte, error) {
	var resp []byte
