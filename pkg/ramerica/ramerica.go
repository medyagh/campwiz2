...
func Search() (*ResultPage, error) {
	...
	if err != nil {
		return &ResultPage{}, errors.Wrap(err, "ClientDo")
	}
	...
	if err != nil {
		log.Printf("failed read Resp body: %v  error: %v", resp, err)
	}
	return &ResultPage{Body: string(body)}, nil
}
